...
Each object should have these exact fields: title, description, learningObjectives (array), primaryDomain, secondaryDomains (array), keyChallenges (array), difficulty.`;
    ...
    const model = this.getModel(
      'You are an ITSM expert and instructional designer creating simulation scenarios for professional training. Provide rich, detailed descriptions that paint a vivid picture of each scenario situation.'
    );
