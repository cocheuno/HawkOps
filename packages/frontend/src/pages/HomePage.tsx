        ...
        <div className="max-w-2xl w-full">
          ...
          <div className="bg-white rounded-lg shadow-2xl p-8">
            <div className="mb-6">
              ...
              <input type="text" id="playerName" value={playerName} onChange={(e) => setPlayerName(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-hawk-purple focus:border-transparent" placeholder="Enter your name" />
            </div>
